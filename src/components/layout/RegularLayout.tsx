...
const RegularLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  <header className="sticky top-0 z-50 w-full border-b border-border/50 bg-white/30 backdrop-blur-xl shadow-lg" style={{ WebkitBackdropFilter: 'blur(24px)', backdropFilter: 'blur(24px)', borderRadius: '0 0 2rem 2rem', boxShadow: '0 8px 32px 0 rgba(31, 38, 135, 0.37)' }}>
  ...
  <main className="flex-1 w-full h-full relative z-10 p-0 m-0 border-none">{children}</main>
